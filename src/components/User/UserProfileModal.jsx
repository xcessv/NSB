...
const UserProfileModal = ({ user: initialUser, onClose }) => {
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      ...
      // If _id is an object with a nested id/userId, extract it
      if (typeof userId === 'object' && userId !== null) {
        userId = userId.id || userId._id || userId.userId;
      }
      
      // Final validation - we need a string ID
  ...
  // This is now positioned fixed relative to the viewport
  return (
